...
export function SectionHeader({
  ...
  return (
    <div className={`flex flex-col gap-2 sm:gap-3 ${alignment}`}>
      {eyebrow && (
        <span className="inline-flex items-center gap-2 rounded-full bg-white/80 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-lifely-indigo shadow-sm ring-1 ring-black/5">
